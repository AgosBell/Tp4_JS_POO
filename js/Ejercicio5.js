...
class Persona {
    ...
    mostrar_generacion() {
      switch (true) {
        ...
        <ul>
          ...
          <li>Rasgo caracteristico: Obsesión por el éxito</li>
        </ul>  
          `);
          break;
        ...
        <ul>
          <li>Naciste en ${this.año_nacimiento}, tu edad es: ${this.edad} años</li>
          <li>El índice de poblacion fue de: 7.800.000</li>
          ...
          break;
        default:
          document.write("<h3>Eres demasiado pequeño</h3>");
          break;
      }
    }
    es_mayor() {
  ...
  const persona_1 = new Persona("Pablo", 2, "11.111.111", "H", 78, 1.78);
